//данный класс заменяет applicationContext.xml
...
@Configuration
@ComponentScan(basePackages = "com.alinaonopina.spring.rest")
@EnableWebMvc
...
public class MyConfig {
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        sessionFactory.setPackagesToScan("com.alinaonopina.spring.rest.entity");
